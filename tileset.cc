...
void drawMap(Hero* h, Point* p) {
	//system("clear");//Can use clearscreen();
	cls();

	int start_x = p->x - XDISPLAY/2;
	int end_x = p->x + XDISPLAY/2;
	int start_y = p->y - YDISPLAY/2;
	int end_y = p->y + YDISPLAY/2;
